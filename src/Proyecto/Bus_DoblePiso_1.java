...
public class Bus_DoblePiso_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Bus_DoblePiso_1 frame = new Bus_DoblePiso_1();
	...
	public Bus_DoblePiso_1() 
	{
		...
		if(g1 >0)
		{
			rbtAsiento61.setBackground(Color.red);
			rbtAsiento61.setEnabled(false);
			rbtAsiento61.setSelected(false);
		}
		if(g2 >0)
		{
			rbtAsiento62.setBackground(Color.red);
			rbtAsiento62.setEnabled(false);
			rbtAsiento62.setSelected(false);
		}
		if(g3 >0)
		{
			rbtAsiento63.setBackground(Color.red);
			rbtAsiento63.setEnabled(false);
			rbtAsiento63.setSelected(false);
		}
		if(g4 >0)
		{
			rbtAsiento64.setBackground(Color.red);
			rbtAsiento64.setEnabled(false);
			rbtAsiento64.setSelected(false);
		}
